      ...
      <header className="bg-[var(--color-bg)]">
        <div className="mx-auto max-w-6xl px-6 py-12 text-center">
          ...
          <div className="mt-5">
            <Link
              href="/"
              className="inline-block rounded-full border border-[var(--color-accent-dim)] px-4 py-1.5 text-sm text-[var(--color-accent)] transition-colors hover:bg-[var(--color-accent-glow)]"
            >
              Enter the museum
            </Link>
          </div>
